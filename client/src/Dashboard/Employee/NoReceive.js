...
const NoReceive = () => {
    ...
    return (
        <div>
            <h3 className="text-2xl mb-3">No Receive</h3>
                ...
                <form onSubmit={handleUpdate}>
                    <table className="table-fixed">
                        ...
                        <tbody className='text-xs'>
                            ...
                            {
                                noReceives?.map((noReceive) =>

                                    <tr key={noReceive.Id}>


                                        {
                                            noReceive?.data?.filter((d) => {
                                                ...
                                                ?.map((d, i) =>
                                                    <tr>
                                                        ...
                                                        <td width="45px" className='min-w-[45px] max-w-[45px]:' style={{ border: "1px solid black" }}>{noReceive.date.slice(0, -14)}</td>
                                                        <td width="45px" className='min-w-[45px] max-w-[45px]:' style={{ border: "1px solid black" }}>{noReceive.courseName}</td>
                                                        <td width="45px" className='min-w-[45px] max-w-[45px]:' style={{ border: "1px solid black" }}>{noReceive.batchName}</td>
                                                        <td width="45px" className='min-w-[45px] max-w-[45px]:' style={{ border: "1px solid black" }}>{noReceive.employeeName}</td>
                                                        <td width="45px" className='min-w-[45px] max-w-[45px]:' style={{ border: "1px solid black" }}>{noReceive.headName}</td>
                                                        ...
                                                        <td width="70px" className='min-w-[70px] max-w-[70px]:' style={{ border: "1px solid black" }}>
                                                            <label onClick={() => handleEdidData(d, noReceive)} htmlFor="editModal" className="btn btn-xs btn-secondary mr-2">Edit</label>
